...
SimpleDateFormat sdfTime = new SimpleDateFormat("yyyyddHHmmss");
		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">水表信息添加</li>
			</ol>
		</div>
			<form action="<%=path %>/shuibiao!add.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
							<th colspan="4">&nbsp;添加水表&nbsp;</td>
						</tr>
						    <tr>
							    <th width="50%">
							         用户Id
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="biaono" name="biaono" value="B_<%=sGenCode%>" readonly="readonly"/>(系統生成)
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<input type="text" id="biaovalue" name="biaovalue" value="0" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
