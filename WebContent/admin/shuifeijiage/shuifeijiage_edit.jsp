		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">水费价格信息修改</li>
			</ol>
		</div>
			<form action="<%=path %>/shuifeijiage!edit.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
							<th colspan="2">&nbsp;修改水费价格&nbsp;</td>
						</tr>
						    <tr>
							    <th width="50%">
							         水费价格(元)
							    ...
							    <td width="50%">
							        	<input type="text" id="jiage" name="jiage" value="${requestScope.Shuifeijiage.jiage}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
							    </td>
								</tr>	
						<tr>
						    <th width="50%">
						    ...
						    <td width="50%">
						       <input type="submit" value="提交" onclick="return check()"/>&nbsp; 
						       		<input type="hidden" name="id" value="${requestScope.Shuifeijiage.id}"/>
