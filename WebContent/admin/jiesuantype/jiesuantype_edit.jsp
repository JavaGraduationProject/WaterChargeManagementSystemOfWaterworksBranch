		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">结算类型信息修改</li>
			</ol>
		</div>
			<form action="<%=path %>/jiesuantype!edit.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
							<th colspan="2">&nbsp;修改结算类型&nbsp;</td>
						</tr>
						    <tr>
							    <th width="50%">
							         结算类型
							    ...
							    <td width="50%">
							        	<input type="text" id="name" name="name" value="${requestScope.Jiesuantype.name}" />
							    </td>
								</tr>	
						<tr>
						    <th width="50%">
						    ...
						    <td width="50%">
						       <input type="submit" value="提交" onclick="return check()"/>&nbsp; 
						       		<input type="hidden" name="id" value="${requestScope.Jiesuantype.id}"/>
