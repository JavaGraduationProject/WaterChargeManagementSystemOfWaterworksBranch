		...
		<div>
			<ol class="breadcrumb">
				<li><span class="glyphicon glyphicon-home"></span>&nbsp;<a
					href="#">主页</a></li>
				<li class="active">公告信息添加</li>
			</ol>
		</div>
			<form action="<%=path %>/gonggao!add.action" name="formAdd" method="post">
				  <table class="table table-hover  table-bordered table-striped">
						<tr>
							<th colspan="4">&nbsp;添加公告信息&nbsp;</td>
						</tr>
						    <tr>
							    <th width="50%">
							         标题
						    ...
						    <tr>
							    ...
							    <td width="50%">
							        	<textarea rows="5" cols="120" id="neirong" name="neirong"></textarea>
							    </td>
								</tr>	
						    <tr>
							    <th width="50%">
		                    ...
		                    <input class="form-control" size="16" type="text"   id="shijian" name="shijian" value="" readonly>
